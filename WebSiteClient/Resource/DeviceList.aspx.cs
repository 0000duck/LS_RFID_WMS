...
public partial class Resource_Device_DeviceList : Page
{
    ...
    private void LoadData(int page)
    {
        ...
        WorkItem.QueryDeviceList(GetQueryDeviceInfo(),pageSize, page,null,isFirstSearch,out recordNum, out retValue);
    ...
    private DeviceInfo GetQueryDeviceInfo()
    {
        DeviceInfo qrDeviceInfo = new DeviceInfo();

        if (!string.IsNullOrEmpty(this.txtDeviceCode.Text))
        {
            qrDeviceInfo.DeviceCode = txtDeviceCode.Text;
        }
        return qrDeviceInfo;
    }
    ...
    protected void GridView1_OnRowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        string deviceID = GridView1.DataKeys[gRow.RowIndex].Value.ToString();

        if (e.CommandName == "Edit")
        {
            Response.Redirect("DeviceEdit.aspx?DeviceID=" + deviceID + " &Type=1");
        }
    }
