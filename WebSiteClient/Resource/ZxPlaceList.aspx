<%@ Page Title="" Language="C#" MasterPageFile="~/MyMaster.master" AutoEventWireup="true"
    CodeFile="ZxPlaceList.aspx.cs" Inherits="Resource_ZxPlace_ZxPlaceList" %>
        ...
        <ContentTemplate>
            <table cellpadding="10" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtZxPlaceCode" runat="server"></asp:TextBox>
                    </td>
                    <td>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <div class="divtdcontent">
                <asp:GridView ID="GridView1" OnRowDataBound="GridView1_OnRowDataBound" DataKeyNames="ZxPlaceID"
                    runat="server">
                    <Columns>
                        <asp:BoundField DataField="serialnum" HeaderText="序号" HeaderStyle-Width="50px">
                        </asp:BoundField>
                        <asp:BoundField DataField="ZxPlaceCode" HeaderText="装卸点编号"></asp:BoundField>
                        ...
                        <asp:TemplateField HeaderText="是否为临时装卸点" HeaderStyle-Width="20%">
                            <ItemTemplate>
                                <%# Convert.ToBoolean(Eval("IsTemporary")) ? "是" : "否"%>
                            </ItemTemplate>
                        </asp:TemplateField>
